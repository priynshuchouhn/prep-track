...
export const recentPosts = [
    {
      id: 1,
      title: "Mastered Binary Search Trees today!",
      content:
        "Finally understood the implementation of BST and solved 5 problems on LeetCode. Feeling confident about DSA interviews now.",
      date: "2 hours ago",
      tags: ["DSA", "Binary Trees", "LeetCode"],
      comments: 12,
      reads: 89,
      user: {
        name: "Priya Sharma",
        avatar: "https://images.unsplash.com/photo-1544725176-7c40e5a71c5e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80",
      },
    },
    {
      id: 2,
      ...
      content:
        "Spent the day understanding useCallback and useMemo hooks. Built a small project to practice performance optimization.",
      date: "5 hours ago",
    ...
    },
    {
      ...
      content:
        "Learned about microservices architecture today. Compared it with monolithic design and understood the trade-offs.",
      date: "Yesterday",
